...
> Бэкенд рассчитан на Railway Serverless. Включи Serverless в настройках Railway; приложение закрывает MongoDB-соединение после 5 минут простоя, чтобы Railway мог усыпить сервис.
